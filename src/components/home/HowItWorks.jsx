...
const HowItWorks = () => {
    return (
        <section className='xui-container xui-py-3'>
            <h3 className='xui-font-sz-200 color-label xui-font-w-400 xui-text-center'>How it works?</h3>
            <div className='xui-row xui-flex-ai-center xui-mt-2'>
                <div className='xui-lg-col-6 xui-col-12'>
                    <img src={HowItWorksImage} className='xui-img-500' alt="" />
                </div>
                <div className="xui-lg-col-6 xui-col-12">
                    <div className="benefits-holder">
                        ...
                        <div className="benefit-right">
                            <h3 className='xui-font-sz-110 color-label xui-font-w-500'>Apply Online</h3>
                    ...
                    <div className="benefits-holder">
                        ...
                        <div className="benefit-right">
                            <h3 className='xui-font-sz-110 color-label xui-font-w-500'>Get Approved</h3>
                    ...
                    <div className="benefits-holder">
                        ...
                        <div className="benefit-right">
                            <h3 className='xui-font-sz-110 color-label xui-font-w-500'>Receive Funds</h3>
                    ...
                    <div className="benefits-holder">
                        ...
                        <div className="benefit-right">
                            <h3 className='xui-font-sz-110 color-label xui-font-w-500'>Repay Easily</h3>
