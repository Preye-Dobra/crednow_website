...
const TestimonialCard = (props) => {
    ...
    return (
        <div className='ca-testimonial-card xui-text-center'>
            <p className='xui-lg-font-sz-85 xui-font-sz-85 color-label xui-line-height-1-half'>{text}</p>
            <div className='testimony-box xui-mt-half xui-bdr-rad-1'>
                ...
                <h3 className='color-label xui-font-w-500 xui-mt-1 xui-lg-font-sz-95 xui-font-sz-75'>{name}</h3>
            </div>
        </div>
    );
};
