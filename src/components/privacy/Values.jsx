    ...
    return (
        <section className='xui-py-1 xui-container'>
                <div className='xui-text-center'>
                    <h3 className='xui-lg-font-sz-200 xui-font-sz-150 color-label xui-lg-font-w-400 xui-font-w-600'>Our Values</h3>
                ...
                <div className='xui-mt-2 xui-lg-p-1 xui-p-none value-holder xui-bdr-rad-1'>
