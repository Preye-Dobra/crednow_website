...
const GetStarted = () => {
    return (
        <section className='bg-label xui-py-3 xui-px-1 xui-bdr-rad-1 xui-pos-relative'>
            <h3 className='xui-font-sz-150 xui-lg-font-w-400 xui-font-w-500'>Get Started Today</h3>
            ...
            <img src={MoneyBag} className='xui-img-400 xui-lg-d-block xui-d-none xui-pos-absolute' style={{top: '-100px', right: '0'}} alt="" />
        </section>
    );
};
